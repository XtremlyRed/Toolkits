...
public class AnimationGroup : AnimationBase
{
    ...
    {
        SetCurrentValue(AnimationDeclaresProperty, new FreezableCollection<Animation>());
    }

    /// <summary>
    ///  animation declares.
    /// </summary>
    public FreezableCollection<Animation> Children
    {
        get { return (FreezableCollection<Animation>)GetValue(AnimationDeclaresProperty); }
    ...
    public static readonly DependencyProperty AnimationDeclaresProperty = DependencyProperty.Register(
        nameof(Children),
        typeof(FreezableCollection<Animation>),
